...
const bn: GuideContent = {
  ...
  hero: {
    ...
    subtitle:
      "ঢাকার রাস্তায় মানুষ যা দেখছে, জ্যাম কেমন তা একটাই লাইভ ম্যাপে এনে দেয় — কোনো ফেসবুক গ্রুপ নয়, অ্যাকাউন্ট নয়, অপেক্ষাও নয়। কীভাবে ম্যাপ পড়বেন, ভালোভাবে রিপোর্ট করবেন আর যা দেখছেন তাতে ভরসা রাখবেন — সবই এখানে।",
    ctaMap: "লাইভ ম্যাপ খুলুন",
    ctaReport: "রিপোর্ট করুন",
  },
  steps: {
    title: "শুরু থেকে শেষ — চারটি ধাপ",
    subtitle: "পুরো কাজটা কয়েক সেকেন্ডের, আর ম্যাপ নিজেই নিজেকে পরিষ্কার রাখে।",
    items: [
      {
        emoji: "👀",
        title: "লাইভ যা আছে দেখুন",
        body: "ম্যাপ খুললেই রঙিন পিনে দেখবেন এই মুহূর্তে মানুষ কী রিপোর্ট করছে — যানজট, জলাবদ্ধতা, দুর্ঘটনা, বন্ধ রাস্তা আরও অনেক কিছু।",
      },
      {
        emoji: "✍️",
      ...
      },
      {
        ...
        body: "ম্যাপে আসার আগে প্রতিটি রিপোর্ট একজন মানুষ যাচাই করেন। এই একটিমাত্র ধাপই স্প্যাম, মজা আর পুরোনো পোস্ট ম্যাপ থেকে দূরে রাখে।",
      },
      {
        emoji: "⏱️",
        title: "নিজে থেকেই মুছে যায়",
        body: "প্রতিটি রিপোর্টের আয়ু বাস্তবের সঙ্গে মেলানো — যানজট দ্রুত মিলিয়ে যায়, রাস্তা বন্ধ থাকে বেশিক্ষণ। কিছুই জমে থাকে না, তাই ম্যাপ মানে সবসময় ‘এখন’।",
      },
    ],
  },
  legend: {
    title: "ম্যাপ পড়ার নিয়ম",
    subtitle: "প্রতিটি পিন একেকটি রিপোর্ট। রঙ বলে সমস্যার ধরন; ব্যাজ বলে কতটা গুরুতর।",
    catDesc: {
    ...
    severityNote:
      "হালকা, মাঝারি না তীব্র — এক নজরে বোঝা যায় এক মিনিট নাকি আধ ঘণ্টা যাবে। তীব্র পিন উজ্জ্বল আলোয় আলাদা করে চোখে পড়ে।",
  },
  tips: {
    title: "স্থানীয়দের মতো রিপোর্ট করুন",
    subtitle: "কয়েকটি অভ্যাস, যা আপনার রিপোর্টকে অন্য সবার জন্য অনেক বেশি কাজের করে তোলে।",
    items: [
      {
        emoji: "📍",
        title: "ঠিক জায়গায় পিন দিন",
        body: "যেখানে সমস্যা সেখানেই পিন টেনে আনুন — মোড়টিতে, আপনি যেখানে দাঁড়িয়ে সেই রাস্তায় নয়। নিখুঁত পিনই মানুষ বিশ্বাস করে।",
      },
      {
        emoji: "🏷️",
        title: "ধরন আর মাত্রা মিলিয়ে দিন",
        body: "সঠিক ধরন আর কতটা খারাপ বেছে দিলে অন্যরা এক কথা না পড়েই এক নজরে বুঝে নিতে পারে।",
      },
      {
        emoji: "💬",
        title: "একটা কাজের লাইন যোগ করুন",
      ...
      },
      {
        ...
        body: "তখন নেট ছিল না? পরে রিপোর্ট করে কখন দেখেছেন তা বেছে দিন। আমরা সময়টা পিছিয়ে দিই, যাতে এটি ঠিক সময়ে মুছে যায়, নতুন বলে ভুল না হয়।",
      },
      {
        emoji: "🔄",
        title: "অন্যের রিপোর্ট সঠিক রাখুন",
        body: "পথে যে পিন পড়ে তাতে ‘এখনও আছে?’ বা ‘পরিষ্কার হয়েছে’ চাপুন। যাচাইয়ের ফাঁকে এই ছোট ছোট চাপই ম্যাপকে সত্য রাখে।",
      },
    ],
  },
  features: {
    title: "শুধু ম্যাপ নয়",
    subtitle: "কয়েকটি জিনিস, যা কোনো ফেসবুক গ্রুপ কখনো দিতে পারে না।",
    items: [
      {
        emoji: "⏳",
        title: "সময় ফিল্টার",
        body: "লাইভ, শেষ ১ ঘণ্টা আর শেষ ৩ ঘণ্টার মধ্যে বদলে কেবল আপনার এই যাত্রার জন্য যা দরকার তা-ই দেখুন।",
      },
      {
        emoji: "🧭",
        title: "রিপোর্টসহ দিকনির্দেশ",
        body: "রুট ঠিক করলে জ্যাম কেমন সেই পথের রিপোর্টগুলো দেখায় — জটে আটকার আগেই জেনে যান।",
      },
      {
        emoji: "🔎",
  ...
  trust: {
    ...
    body: "জনতার রিপোর্টে ট্রাফিক দেখানোর কঠিন অংশ পিন আঁকা নয় — কঠিন হলো ভুয়া, পুরোনো আর অপ্রয়োজনীয় তথ্য ঠেকানো। জ্যাম কেমন গোড়া থেকেই সেটি মাথায় রেখে তৈরি।",
    points: [
      "ম্যাপে আসার আগে প্রতিটি রিপোর্ট একজন মানুষ যাচাই করেন। কিছুই নিজে থেকে দেখা যায় না।",
      "রিপোর্ট নিজে থেকেই মুছে যায়, সমস্যার সঙ্গে মিলিয়ে — তাই ম্যাপ এখনকার, তিন ঘণ্টা আগের নয়।",
      "একই ঘটনার কাছাকাছি রিপোর্টগুলো একত্র হয়, আর সবচেয়ে নতুন তথ্যটি টিকে থাকে।",
      "যাচাইয়ের ফাঁকে কমিউনিটি ‘এখনও আছে’ আর ‘পরিষ্কার’ চাপে সত্যটা ধরে রাখে।",
    ],
    honest:
  ...
  quality: {
    title: "ডেটা সম্পর্কে",
    body: "জ্যাম কেমন-এর রিপোর্ট আসে রাস্তায় থাকা মানুষের কাছ থেকে — কোনো ট্রাফিক সেন্সর বা ভবিষ্যদ্বাণীর মডেল থেকে নয়। এটাই ঠিক করে দেয় কোথায় এটি দুর্দান্ত আর কোথায় দুর্বল।",
    points: [
      "রাস্তা কেন লাল তা ব্যাখ্যা করে — দুর্ঘটনা, জলাবদ্ধতা, মিছিল — শুধু রঙ দিয়ে নয়।",
      "মডেলভিত্তিক ম্যাপের চেয়ে প্রায়ই দ্রুত, কারণ ঘটনার মুহূর্তেই একজন মানুষ রিপোর্ট করেন।",
      "কভারেজ মানুষের ওপর নির্ভর করে: ব্যস্ত এলাকা দ্রুত ভরে, শান্ত এলাকায় পিন কম থাকতে পারে।",
      "মান ধরে রাখে সেই তিনটি জিনিসই — মানুষের যাচাই, নিজে থেকে মুছে যাওয়া আর ডুপ্লিকেট একত্র করা।",
    ],
    honest:
      "একে ভাবুন ‘এই মুহূর্তে মানুষ কোথায় সমস্যা জানাচ্ছে’ — সেন্সর-মানের গতি-তথ্য নয়। ফাঁকা এলাকা মানে এখনও কেউ জানায়নি, রাস্তা পরিষ্কার তা নয়।",
  },
  faq: {
    ...
    items: [
      ...
      {
        q: "এটা কি ফ্রি?",
        a: "হ্যাঁ, পুরোপুরি। জ্যাম কেমন ঢাকার জন্য একটি কমিউনিটি প্রকল্প, বিনামূল্যে ব্যবহারযোগ্য।",
      },
      {
      ...
      },
      {
        ...
        a: "গুগল মডেলে-অনুমান করা রঙ দেখায় যা বাস্তবের চেয়ে পিছিয়ে থাকতে পারে আর কারণ বলে না। জ্যাম কেমন দেখায় লাইভ মানুষের রিপোর্ট, যা আসলে কী হচ্ছে তা বলে।",
      },
      {
